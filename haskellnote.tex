...
\begin{align}
\mathId\mathFMap\mathPure{x}&=\mathId\mathPure{x}\\
(g\mathCompose f)\mathFMap\mathPure{x}&=((f\mathFMap)\mathCompose(g\mathFMap))\mathPure{x}\\
&=f\mathFMap(g\mathFMap\mathPure{x})
\end{align}

Applicative law.
\begin{align}
\mathId\mathApplicativeMap\mathPure{x}&=\mathPure{x}\\
...
&=\mathPure{h}\mathApplicativeMap\mathMakePure{g\mathCompose f}
\end{align}
