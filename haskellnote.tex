...
\end{align}
% つまり組み合わせ$(\mathTypeFunction{\mathTypeGeneral{a}}{\mathTypeGeneral{a}},\mathId,\mathFMap)$はモノイドである．--結合性は示していない．
...
\end{align}
であるとき，組み合わせ$(\mathTypeGeneral{a},\mathIdentity,\mathAnyBinaryOperator)$をモノイドと呼ぶ．
...
(h\mathCompose g)\mathCompose f&=h\mathCompose(g\mathCompose f)
\end{align}
そこで組み合わせ$(\mathTypeFunction{\mathTypeGeneral{a}}{\mathTypeGeneral{a}},\mathId,\mathCompose)$はモノイドであると言える．

他に，組み合わせ$(\mathTypeInt,0,+)$や$(\mathTypeInt,1,\times)$もモノイドである．
...
\mathStar{\mathMonadic{g}}\left(\mathStar{\mathMonadic{f}}\mathPure{x}\right)&=\mathStar{\left(\mathStar{\mathMonadic{g}}\mathMonadic{f}\right)}\mathPure{x}
\end{align}
